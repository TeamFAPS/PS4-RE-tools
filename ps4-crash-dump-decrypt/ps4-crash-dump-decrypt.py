#!/usr/bin/env python
'''
PS4 Crash Dump Decrypt by SocraticBliss (R)

Thanks to... 
# Team FailOverflow, CelesteBlue and zecoxao

How to use:
1) Put orbiscore-systemcrash.orbisstate in the same directory as this python script
2) Execute python ps4-crash-dump-decrypt.py
'''
...
class Header:
	def __init__(self, f):
		__slots__ = ('VERSION', 'OPEN_PSID', 'PADDING_1', 'PADDING_2', 'UNKNOWN', 'STATE', 'DATA_LEN', 'PADDING_3', 'DATA_HMAC')
...
KEYS = [
	...
	[b'04C1A0961BBB0CB2140361B0956AAABA', b'052D2FF3014FB38CAAF6898CB899982A'], # 4.06-4.07
]
